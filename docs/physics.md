...
### 4.1 Blast-wave CLI parameterization

The spectra prediction step (predict_light_spectra app) is controlled by the blast-wave inputs and the multiplicity grid:
...
### 8.4 Docker equivalent workflow
